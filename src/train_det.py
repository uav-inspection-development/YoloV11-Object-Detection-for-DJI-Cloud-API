...
def train_det(workers, batch, device, data_name, epochs, img_size):
    try:
        ...
        results = model.train(  # 开始训练模型
            ...
            name=f'detection_task_{data_name}_{current_time}',  # 指定训练任务的名称
        ...
        return (
            f"检测任务训练成功完成！\n"
            f"任务名称: detection_task_{data_name}_{current_time}\n"
        ...
        return f"Error during detection training: {str(e)}"
